...
export default function ContactForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 bg-slate-100 pt-24">

            <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="w-full max-w-2xl bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden"
            >
                {/* Header */}
