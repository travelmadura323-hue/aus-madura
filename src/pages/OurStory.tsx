...
const logos = [
  {
    ...
    description:
      "An Aussie Specialist is a travel agent who has completed official training about Australia's destinations, attractions, and travel planning. This certification shows that the agent has expert knowledge of Australian travel.",
  },
  {
    image: im['../../images/im/Ministry of Tourism.jpg'],
    title: "Ministry of Tourism India",
    description:
      "Official recognition from India's Ministry of Tourism, certifying our commitment to promoting tourism and maintaining high standards in travel services.",
  },
];
...
const accreditationDetails = [
  {
    ...
    title: "IAAI",
    description:
      "Indian Association of Tour Operators (IAAI) is a premier organization representing tour operators and travel agencies in India, promoting ethical business practices and professional standards in the tourism industry.",
  },
  {
  ...
  },
  {
    ...
    title: "TAAI",
    description:
      "Travel Agents Association of India (TAAI) is one of the oldest and most respected associations of travel agents in India, ensuring professional excellence and consumer protection.",
  },
  {
    image: im['../../images/im/tafi.jpg'],
    title: "TAFI",
    description:
      "Travel Agents Federation of India (TAFI) is a national body representing travel agents and tour operators, working towards the growth and development of the travel industry in India.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="grid items-start gap-8 lg:gap-12 lg:grid-cols-2">
            <div>
              ...
              <h6 className="text-3xl text-primary">Establishment</h6>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Madura Global is a premium travel and advisory platform
                connecting Australia with India and select international
                destinations through curated, intelligently designed journeys.
                Built upon the 40-year legacy of Madura Travel Service (P) Ltd
                in India, our foundation is rooted in operational depth,
                long-standing regional partnerships and multi-generational
                expertise.
              </p>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                We specialise in crafting structured travel experiences that
                balance cultural authenticity with refined execution. From
                heritage landscapes and spiritual circuits to contemporary
                luxury itineraries, every journey is thoughtfully designed for
                Australian travellers seeking clarity, comfort and meaningful
                engagement.
              </p>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Madura Global does not operate as a transactional tour reseller.
                We function as a strategic bridge — combining Australian
                consultation standards with on-ground precision across India and
                beyond. Our commitment is to deliver travel experiences defined
                by discretion, structure and enduring quality.
              </p>
              <h6 className="text-3xl text-primary">Awards & Recognition</h6>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Over the years, our company has earned recognition from numerous
                esteemed government and private institutions. Notably, we are
                honored to have received the prestigious Kalaimamani Award from
                the Government of Tamil Nadu, a testament to our commitment and
                excellence in the travel industry. We take pride in being the
                sole recipient of the Kalaimamani Award within the entire travel
                fraternity. Additionally, our achievements include securing two
                Limca Records for orchestrating the largest cultural groups from
                India to destinations worldwide, and pioneering the entry into
                the digital market during the early 2000s. Furthermore, we have
                consistently ranked as a top seller for various airlines,
                including Air India, Oman Air, Jet Airways, SriLankan Airlines,
                among others.
              </p>
              <h6 className="text-3xl text-primary">Travel & Visa</h6>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Your trusted travel partner in seamless travel experiences for
                over 39 years. Established in 1986, we have been committed to
                providing unparalleled service for both international and
                domestic Air Ticketing, Train and bus Services & Cruise Transport
                and expertise in visa facilitation for across 195 Countries.
              </p>
              <h6 className="text-3xl text-primary">Tourism and Ancillary Services</h6>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Your premier choice for unforgettable travel experiences backed
                by 39 years of expertise and the esteemed approval of the
                Ministry of Tourism, Government of India. We have been dedicated
                to curating exceptional journeys for millions of passengers
                including Families, Honeymooners, Corporate & Business
                travellers, Solo Travellers, Student Educational Trips and many
                more.
              </p>
            </div>
            ...
            <div className="relative w-full overflow-hidden rounded-2xl">
              <img
                src={
                  images[
                    '../../images/WhatsApp-Image-2024-11-21-at-16.41.41_0f849961-767x1024 (1).jpg'
                  ] as string
                }
